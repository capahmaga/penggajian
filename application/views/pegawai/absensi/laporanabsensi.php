...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('admin/absensi/aporanabsensi') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
                ...
                <div class="card-body">
                    <form class="form-inline" method="post" action="">
                        <div class="row">
                            ...
                            <button type="submit" class="btn btn-primary mx-sm-3 mb-2"><i class="fas fa-eye"></i> Tampilkan Data</button>
                        </div>
                    </form>
                </div>
            </div>
