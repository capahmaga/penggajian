  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php if ($this->session->userdata('role') == 1) : ?>
        ...
        <li class="nav-item<?= $this->uri->segment(2) == 'pegawai' || $this->uri->segment(2) == 'jabatan' || $this->uri->segment(2) == 'potongangaji' || $this->uri->segment(2) == 'intensif' ? ' active' : ''; ?>">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-database"></i>
            <span>Master Data</span>
          </a>
          <div id="collapseTwo" class="collapse<?= $this->uri->segment(2) == 'pegawai' || $this->uri->segment(2) == 'jabatan' || $this->uri->segment(2) == 'potongangaji' || $this->uri->segment(2) == 'intensif' ? ' show' : ''; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item<?= $this->uri->segment(2) == 'intensif' ? ' active' : ''; ?>" href="<?= base_url('admin/intensif'); ?>">Setting Intensif</a>
            </div>
          </div>
        </li>

        <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item<?= $this->uri->segment(2) == 'absensi' || $this->uri->segment(2) == 'gaji'  ? ' active' : ''; ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h1 class="h3 text-gray-800"> | Yayasan Pendidikan Syifauzzahra Pekalongan | </a>
          </h1>
